...
# Puerto 0 origen -g 0
nmap $1 $2 $3 $4 -Pn --open -sACV  -T4 -f -O --max-retries 1 --defeat-rst-ratelimit --script firewall-bypass,http-waf-fingerprint,http-waf-detect -oG resultado_firewall.txt
