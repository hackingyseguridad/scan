...
do nmap $1 -PE -sV -iL todas.txt --open -O -n --defeat-rst-ratelimit --randomize-hosts --max-retries 2 -O --osscan-guess --defeat-rst-ratelimit --script=default,banner,vuln,vulners --script-args mincvss=8 -oX index.xml -oN $contador
