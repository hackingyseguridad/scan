...
do nmap $1 -iL ip.txt -F -PE -sTV --open -O -n --defeat-rst-ratelimit --randomize-hosts --max-retries 2 -O --osscan-guess $0 --min-rate 1000 --script=default,banner,vuln,vulners --script-args mincvss=8  -oN $contador -oX index.xml
