...
do sudo nmap $1 -iL ip.txt -Pn -sTVC -O --open -p 21,22,23,25,53,123,139,161,222,389,443,445,500,554,631,966,1023,1720,1723,1080,2022,2222,3389,5222,5900,7443,8080,8443,8888,10000,22222 -O  --defeat-rst-ratelimit  --script=default,vuln,vulners --script-args mincvss=7 -oX index.xml -oG $contador
